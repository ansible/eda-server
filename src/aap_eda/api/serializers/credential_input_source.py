...
class CredentialInputSourceCreateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        source_credential = models.EdaCredential.objects.get(
            id=attrs.get("source_credential")
        )
        target_credential = models.EdaCredential.objects.get(
            id=attrs.get("target_credential")
        )
        ...
        attrs["source_credential"] = source_credential
        attrs["target_credential"] = target_credential
...
class CredentialInputSourceRefSerializer(serializers.ModelSerializer):
    ...
    def get_metadata(self, instance) -> dict:
        """Retrieve the metadata from the instance."""
        return _get_metadata(instance)
