...
class Engine(ContainerEngine):
    ...
    def _handle_pull_policy(
        ...
        if pull_policy_enum == ImagePullPolicy.ALWAYS:
            ...
            self._pull_image(request, log_handler)
        elif pull_policy_enum == ImagePullPolicy.NEVER and not image_existed:
            error_message = (
