...
class ContainerRequest(BaseModel):
    ...
    k8s_pod_affinity: tp.Optional[dict] = None
    k8s_mem_limit: tp.Optional[str] = None
    k8s_cpu_limit: tp.Optional[str] = None
...
class ContainerableMixin:
    def get_container_request(self) -> ContainerRequest:
        ...
        return ContainerRequest(
            ...
            k8s_pod_affinity=self.k8s_pod_affinity or {},
            k8s_mem_limit=settings.K8S_MEM_LIMIT,
