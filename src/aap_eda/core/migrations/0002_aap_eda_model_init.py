...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="rulebook",
            index=models.Index(
                fields=["project_id"], name="ix_rulebook_project_id"
            ),
        ),
        migrations.AddConstraint(
            model_name="rulebook",
        ...
        migrations.AddIndex(
            model_name="rule",
            index=models.Index(
                fields=["ruleset_id"], name="ix_rule_ruleset_id"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="rule",
        ...
        migrations.AddIndex(
            model_name="playbook",
            index=models.Index(
                fields=["project_id"], name="ix_playbook_project_id"
            ),
        ),
        migrations.AddIndex(
            model_name="inventory",
        ...
        migrations.AddIndex(
            model_name="auditrule",
            index=models.Index(
                fields=["rule_id"], name="ix_audit_rule_rule_id"
            ),
        ),
        migrations.AddIndex(
            model_name="auditrule",
        ...
        migrations.AddIndex(
            model_name="activationinstancejobinstance",
            index=models.Index(
                fields=["job_instance_id"], name="ix_ainst_jinst_job_inst_id"
            ),
        ),
        migrations.AddIndex(
            model_name="activationinstance",
            index=models.Index(
                fields=["project_id"], name="ix_act_inst_project_id"
            ),
        ),
        migrations.AddIndex(
            model_name="activationinstance",
