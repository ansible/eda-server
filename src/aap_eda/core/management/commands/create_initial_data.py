...
WEBHOOK_HMAC_INPUTS = {
    "fields": [
        ...
        {
            "id": "hmac_signature_prefix",
            "label": "HMAC Signature Prefix",
            "type": "string",
            "help_text": (
...
WEBHOOK_BASIC_INPUTS = {
    ...
    "required": ["auth_type", "secret", "username", "header_key"],
}
...
WEBHOOK_TOKEN_INPUTS = {
    ...
    "required": ["auth_type", "secret", "header_key"],
}
...
WEBHOOK_OAUTH2_JWT_INPUTS = {
    ...
    "required": ["auth_type", "jwks_url", "header_key"],
}
...
WEBHOOK_DYNATRACE_INPUTS = {
    ...
    "required": ["auth_type", "username", "secret", "header_key"],
}
