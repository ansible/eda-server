...
def _manage(process_parent_type: str, id: int) -> None:
    ...
    """
    try:
        klass = import_string(process_parent_type)
...
def _can_start_new_process(process_parent: Any) -> bool:
...
def start_rulebook_process(process_parent_type: str, id: int) -> None:
...
def stop_rulebook_process(process_parent_type: str, id: int) -> None:
...
def delete_rulebook_process(process_parent_type: str, id: int) -> None:
...
def restart_rulebook_process(process_parent_type: str, id: int) -> None:
