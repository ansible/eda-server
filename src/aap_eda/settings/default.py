...
EVENT_STREAM_BASE_URL = settings.get(
    "EVENT_STREAM_BASE_URL", "https://change-me:8443/some-uuid"
)
if EVENT_STREAM_BASE_URL:
    EVENT_STREAM_BASE_URL = EVENT_STREAM_BASE_URL.strip("/") + "/"

EVENT_STREAM_MTLS_BASE_URL = settings.get(
    "EVENT_STREAM_MTLS_BASE_URL", "https://change-me:8443/mtls/some-uuid"
)
