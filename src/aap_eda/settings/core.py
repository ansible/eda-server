...
DISPATCHERD_PROJECT_TASK_TIMEOUT = 300  # 5 minutes for project import/sync
DISPATCHERD_ANALYTICS_TASK_TIMEOUT = 3600  # 1 hour for analytics gathering
DISPATCHERD_ACTIVATION_TASK_TIMEOUT = 300  # 5 minutes for activation
...
DEFAULT_SYSTEM_RULE_ENGINE_CREDENTIAL_NAME = "_DEFAULT_EDA_RULE_ENGINE_CREDS"
