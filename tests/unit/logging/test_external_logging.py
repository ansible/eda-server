...
# from aap_gateway_api.tests.functional.test_settings import _mock_logging_defaults
...
def test_rsyslog_conf_template(enabled, log_type, host, port, protocol, errorfile, expected_config, mocker):
    # Set test settings
