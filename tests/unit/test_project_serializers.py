...
def test_includes_needs_update_on_launch_field(default_organization):
...
@pytest.mark.django_db
def test_needs_update_false_when_disabled(default_organization):
...
@pytest.mark.django_db
def test_needs_update_true_when_cache_expired(default_organization):
...
@pytest.mark.django_db
def test_needs_update_false_when_cache_valid(default_organization):
