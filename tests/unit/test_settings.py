...
def test_url(mock_settings):
    mock_settings.EVENT_STREAM_BASE_URL = "https://myhost.com/esbu"
    mock_settings.EVENT_STREAM_MTLS_BASE_URL = "https//myhost.com/esmbu"
    post_loading(mock_settings)

    assert mock_settings.EVENT_STREAM_BASE_URL == "https://myhost.com/esbu/"
    assert (
        mock_settings.EVENT_STREAM_MTLS_BASE_URL == "https//myhost.com/esmbu/"
    )
