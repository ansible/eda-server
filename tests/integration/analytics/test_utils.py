...
def test_collect_controller_info(
    ...
    new_aap_credential: models.EdaCredential,
    ...
    # hosts defined in default AAP credentials
    default_host = "https://eda_controller_url"
    new_host = "https://new_eda_controller_url"
