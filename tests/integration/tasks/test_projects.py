...
@patch("aap_eda.tasks.project.check_rulebook_queue_health")
def test_check_project_queue_health_keyboard_interrupt(
    mock_check_rulebook_health,
):
    """Test check_project_queue_health handles KeyboardInterrupt gracefully."""
    mock_check_rulebook_health.side_effect = KeyboardInterrupt(
        "User interrupted"
    )
