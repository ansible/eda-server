...
from ansible_base.rbac.migrations._utils import create_custom_permissions
...
def test_create_all_roles():
    ...
    Command().handle()
    role_types = [rd.content_type.model if rd.content_type else None for rd in RoleDefinition.objects.all()]
