...
from eda_api import rest
from eda_api.configuration import Configuration
from eda_api.exceptions import ApiTypeError, ApiValueError, ApiException
from eda_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ActivationInstancesApi()
        api_instance.activation_instances_destroy  # this is an instance of the class Endpoint
        api_instance.activation_instances_destroy()  # this invokes api_instance.activation_instances_destroy.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.activation_instances_destroy.callable or self.callable in this class
